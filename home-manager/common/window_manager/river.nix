          ...
          normal =
            ...
            let
              ...
              tagKeys = concatMapAttrs (index: tag: {
                "Super ${index}" = "set-focused-tags ${toString tag}";
                "Super+Shift ${index}" = "set-view-tags ${toString tag}";
                "Super+Control ${index}" = "toggle-focused-tags ${toString tag}";
                "Super+Shift+Control ${index}" = "set-view-tags ${toString tag}";
              }) (listToAttrSet tagMap);
            in
            tagKeys
            // {
              "Super Q" = "spawn foot";
